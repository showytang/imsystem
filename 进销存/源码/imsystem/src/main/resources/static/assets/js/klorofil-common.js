		...
		.ready(
				function() {
							...
							.on(
									...
									function() {
										...
										$(this)
												.find('.lnr')
												.toggleClass(
														'lnr-arrow-left-circle lnr-arrow-right-circle');
					...
					$(window).on(
							...
							function() {
								if ($(window).innerWidth() < 1025) {
									$('.btn-toggle-fullwidth').find(
											'.icon-arrows').removeClass(
											'icon-arrows-move-left').addClass(
								...
								// if page has content-menu, set top padding of
								// main-content
					...
					$('.panel .btn-toggle-collapse').clickToggle(
							function(e) {
								...
								// if has scroll
								if ($(this).parents('.panel').find(
										'.slimScrollDiv').length > 0) {
									affectedElement = $('.slimScrollDiv');
								}

								$(this).parents('.panel').find(affectedElement)
										.slideUp(300);
								$(this).find('i.lnr-chevron-up').toggleClass(
										'lnr-chevron-down');
							},
							function(e) {
								e.preventDefault();
